      ...
      <div className="wrapper-modal">
        <div className="card border-0 d-flex flex-column rounded-4 justify-content-center custom-modal">
          ...
          <div className="card-body p-0">
            ...
            <p className="card-text fs-4 text-center text-wrap">{content}</p>
            ...
            <div className="d-flex flex-row justify-content-center w-100 gap-3 mt-3">
              <Button
                ...
                className={
                  "btn-primary text-white fw-semibold w-50 text-nowrap"
                }
              >
                Tidak
              </Button>
              <Button
                ...
                className={
                  "btn-outline-primary fw-semibold border-2 rounded-2 w-50"
                }
              >
                {disabled ? (
                  <span
